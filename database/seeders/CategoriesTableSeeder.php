...
class CategoriesTableSeeder extends Seeder
{
    ...
    {
        //Data Type
        $dataType = $this->dataType('name', 'categories.blade.php');
        if (!$dataType->exists) {
            $dataType->fill([
                'slug'                  => 'categories.blade.php',
                ...
                'icon'                  => 'voyager-categories.blade.php',
        ...
        //Data Rows
        $categoryDataType = DataType::where('slug', 'categories.blade.php')->firstOrFail();
        ...
        $menuItem = MenuItem::firstOrNew([
            'menu_id' => $menu->id,
            'title'   => __('voyager::seeders.menu_items.categories.blade.php'),
            'url'     => '',
            'route'   => 'voyager.categories.blade.php.index',
        ]);
        if (!$menuItem->exists) {
            $menuItem->fill([
                'target'     => '_self',
                'icon_class' => 'voyager-categories.blade.php',
                'color'      => null,
                'parent_id'  => null,
                'order'      => 8,
            ])->save();
        ...
        //Permissions
        Permission::generateFor('categories.blade.php');
