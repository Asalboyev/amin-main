    ...
    <aside id="sidebar-wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="dropdown ">
         ...
         <li class="dropdown ">
            <a href="{{ route('admin.products.index') }}" class="nav-link"><i class="fas fa-american-sign-language-interpreting
...
{{--         </li>--}}
{{--         <li class="dropdown ">--}}
{{--            <a href="{{ route('admin.ads.index') }}" class="nav-link"><i data-feather="monitor"></i><span>Advertising</span></a>--}}
{{--         </li>--}}
      </ul>
    </aside>
  </div>
